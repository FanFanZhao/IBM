<template>
	<div class="nav_bar">
		<div class="content clear" style="height:45px">
			<div class="fl" style="margin-top:7.5px;border-radius:50%;over-flow:hidden;width:30px;height:30px;background:#fff;overflow:hidden"><img src="@/assets/images/logo.jpg" class="navbar-logo" style="display:block;width:30px;height:30px"></div>
